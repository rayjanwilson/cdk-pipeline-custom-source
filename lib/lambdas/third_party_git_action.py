            ...
            try:
                ...
                while (counter < 60 and buildStatus != 'SUCCEEDED'):
                    ...
                    if buildStatus == 'SUCCEEDED':
                        ...
                        commit_id = [
                            env for env in EnvVariables if env['name'] == 'GIT_COMMIT_ID'][0]['value']
                        commit_message = [
                            env for env in EnvVariables if env['name'] == 'GIT_COMMIT_MSG'][0]['value']
                        current_revision = {
                        ...
                        codepipeline_client.put_job_success_result(
                            jobId=job['id'], currentRevision=current_revision, outputVariables=outputVariables)
                        break
